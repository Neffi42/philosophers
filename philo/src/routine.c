...
/*   Updated: 2024/02/26 10:30:00 by abasdere         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	simulation(t_philo *philo, long long current_time)
{
	...
	if (philo->rules.time_die < current_time - philo->last_meal)
		philo->state = DEAD;
